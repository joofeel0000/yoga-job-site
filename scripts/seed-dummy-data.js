...
const COMMUNITY_POOL = {
  자유게시판: [
    ...
    {
      title: '요가 수업 중 웃겼던 에피소드 공유해요',
      content: '오늘 수업 중에 너무 웃긴 일이 있었어요. 공유하고 싶어서요.\n\n수련 중에 갑자기 회원 한 분이 방귀를 뀌셨는데 (비라바드라사나 포즈 중이었어요), 본인이 너무 당황해서 "죄송해요, 요가가 너무 효과가 좋아서..." 라고 하시는 바람에 온 수련실이 웃음바다가 됐어요.\n\n항상 진지하기만 한 분이셨는데 그 이후로 수업 분위기가 훨씬 밝아졌어요.\n\n요가 강사들만 아는 이런 순간들 있잖아요. 여러분들 경험도 나눠주세요!',
    },
    {
  ...
  '강사Q&A': [
    ...
    {
      title: '프리랜서 강사 계약서 꼭 써야 하나요?',
      content: '신규 센터에서 프리랜서로 일하게 됐는데 계약서 없이 구두로만 진행하자고 해서 좀 불안하네요.\n\n실제로 계약서 없이 일하다 문제가 생긴 분 계신가요? 계약서에 꼭 들어가야 할 항목들도 알려주시면 감사하겠습니다. 특히 수업료 정산 방식, 레슨비 취소 환불 규정, 수업 자료 저작권 같은 부분이 궁금해요.',
    },
  ],
  ...
  노하우: [
    ...
    },
    {
      ...
      content: '코로나 이후 온라인 수업을 계속 병행하고 있는데, 플랫폼별 장단점을 공유해볼게요.\n\n【줌(Zoom) 라이브 클래스】\n장점: 실시간 피드백 가능, 참가자 얼굴 보며 자세 교정\n단점: 참가자 수 제한 (무료 40분), 유료 구독 필요\n적합: 소규모 그룹, 개인 레슨\n\n【유튜브 라이브 & VOD】\n장점: 무제한 참여자, 콘텐츠 자산화 가능\n단점: 즉각 수익화 어려움, 구독자 확보가 관건\n적합: 브랜딩 목적, 무료 콘텐츠\n\n【인스타그램 라이브】\n장점: 팔로워와 즉각 소통, 별도 설치 불필요\n단점: 화질 한계, 저장 기간 짧음\n적합: 짧은 모닝 루틴, 15~30분 클래스\n\n저는 현재 줌으로 유료 소그룹 운영 + 유튜브로 무료 콘텐츠 제공하는 투트랙을 쓰고 있어요.',
    },
    {
      title: '요가원 예약 시스템 1년 사용 후기 총정리',
      content: '지난 1년간 다양한 요가원 관리 프로그램을 써본 경험을 공유해요.\n\n【네이버 예약】\n무료로 시작하기에 좋고 네이버 플레이스와 연동이 강점입니다. 복잡한 회원권 관리나 출석 체크는 기능이 부족해요.\n\n【클래스픽】\n요가·필라테스 스튜디오 특화. 회원권 종류 설정이 자유롭고 카카오 알림톡 자동 발송이 편리합니다. 월 3~7만원대.\n\n【자체 구글 시트】\n비용 절감 최고. 단점은 자동화가 안 된다는 것. 회원 10명 이하 소규모라면 충분합니다.\n\n결론: 회원 30명 미만은 네이버예약 + 구글시트, 30~100명은 클래스픽 추천합니다.',
    },
    {
      title: '신규 회원 이탈을 줄이는 첫 달 케어 방법',
      content: '강사로 3년 넘게 운영하면서 깨달은 건데, 첫 달 이탈률이 제일 높더라고요.\n\n제가 실제로 효과를 봤던 방법들:\n\n1. 첫 수업 후 24시간 안에 카카오톡 메시지 - "오늘 수업 어떠셨나요?" 한 줄이면 충분\n2. 3회 수업 후 짧은 피드백 세션 (5분) - 강사가 먼저 챙기고 있다는 느낌을 주는 게 중요\n3. 한 달 목표 설정 카드 작성 - 첫날 같이 써서 한 달 후 꺼내보기\n4. 결석 시 다음 날 체크인 메시지 (강요 아닌 응원 톤으로)\n\n이렇게 했더니 첫 달 재등록률이 60%→82%로 올랐어요. 큰 비용 들이지 않고도 가능한 방법들이라 공유합니다.',
    },
    {
      title: '요가 수업 커리큘럼 짤 때 제가 쓰는 4단계 프레임',
      content: '강사 생활 7년 동안 수업 커리큘럼 짜는 방법이 많이 바뀌었어요. 지금 제가 쓰는 프레임 공유할게요.\n\n1단계 - 의도 설정 (5분): 오늘 수업이 끝난 후 수강생이 어떤 상태이길 바라는가를 한 문장으로 정리\n\n2단계 - 워밍업 설계 (10~15분): 오늘 수업의 핵심 동작과 관련된 관절/근육을 중심으로 가볍게\n\n3단계 - 메인 시퀀스 (25~35분): 피크 포즈 1~2개 중심으로 전후 흐름을 역산해서 설계\n\n4단계 - 쿨다운 & 샤바사나 (10~15분): 긴장 이완 + 통합 시간, 절대 줄이지 않음\n\n이 프레임으로 짜면 수업이 산만해지지 않고, 수강생들도 흐름을 자연스럽게 따라오는 느낌이에요.',
    },
  ],

  후기: [
    {
      title: '요가로 허리 디스크 극복한 후기 (강사 입장에서)',
      content: '제가 직접 겪은 일이라 공유하고 싶었어요.\n\n강사 4년차에 허리 디스크가 왔어요. L4-L5 돌출 진단을 받고 3개월 수업을 못 했는데, 그 기간이 오히려 요가를 다시 보게 되는 계기가 됐어요.\n\n재활하면서 배운 것들:\n- 과도한 백벤드가 문제였던 게 맞았어요. 하루 10개 넘게 하고 있었거든요\n- 코어 강화 없이 유연성만 늘리는 게 얼마나 위험한지 깨달았어요\n- 지금은 수업에서 코어와 안정성을 훨씬 강조하게 됐고요\n\n6개월 만에 완전히 복귀했고 지금은 오히려 수업 퀄리티가 더 좋아졌다고 피드백을 받아요. 부상도 결국 배움이 될 수 있더라고요.',
    },
    {
      title: '해외 요가 리트릿 다녀온 후기 (발리 우붓)',
      content: '지난달 발리 우붓 요가 리트릿을 다녀왔어요. 강사로서 수련 차원에서 다녀온 거라 강사 시각에서 후기 남겨요.\n\n프로그램: 5박 6일, 아침·저녁 2회 수련, 철학 강의 포함\n비용: 항공 포함 약 220만원\n\n좋았던 점:\n- 매일 아침 6시 수련이 처음엔 힘들었는데 3일째부터 몸이 적응하면서 정말 좋았어요\n- 국제 강사들의 수업 스타일을 직접 경험하는 것 자체가 큰 공부\n- 같은 목적으로 온 사람들과의 교류가 예상보다 훨씬 값졌어요\n\n아쉬운 점:\n- 철학 강의가 영어로만 진행돼서 일부 내용 이해에 한계가 있었어요\n\n1~2년에 한 번은 이런 집중 수련 경험을 추천합니다.',
    },
    {
      title: '처음으로 내 이름 건 워크숍 진행 후기',
      content: '지난 주말, 처음으로 제 이름을 건 워크숍을 진행했어요.\n\n주제: "현대인을 위한 소마틱 요가 - 몸의 언어 듣기"\n참가자: 12명\n장소: 지인 스튜디오 빌려서 진행\n비용: 참가비 5만원, 재료비·장소 임대 제외 실수익 약 35만원\n\n준비하면서 힘들었던 부분:\n- 커리큘럼 짜는 게 생각보다 훨씬 오래 걸렸어요 (약 3주)\n- SNS 홍보가 어색해서 지인 위주로 모집했더니 12명 채우는 데 시간이 걸렸고\n\n막상 진행하면서:\n- 수강생들이 집중하는 게 느껴질 때 정말 보람 있었어요\n- 수업 후 "오늘 처음으로 내 몸이랑 대화한 것 같아요"라는 피드백에 눈물이 날 뻔\n\n수익보다 경험 자체가 너무 값진 하루였어요. 내년엔 정기 워크숍으로 만들고 싶어요.',
    },
    {
      title: 'RYT 500 취득 후기 - 1년이 지난 시점에서 솔직하게',
      content: 'RYT 500을 작년에 취득했고, 이제 1년이 지났어요. 취득 전후를 솔직하게 비교해볼게요.\n\n취득 비용: 약 350만원 (국내 인증 스쿨)\n소요 기간: 약 8개월 (주말 집중 과정)\n\n달라진 것:\n- 수업료를 시간당 5천원~1만원 올릴 수 있었어요\n- 아나토미 지식이 확실히 깊어져서 자세 교정이 더 세밀해졌고\n- 요가 철학 공부가 제 수업 언어를 많이 바꿔줬어요\n\n달라지지 않은 것:\n- 취득 자체만으로 갑자기 수강생이 늘진 않아요\n- 구직 시 RYT 200이랑 체감 차이가 크진 않더라고요 (국내 기준)\n\n결론: 자기 수련 및 수업 퀄리티 향상 목적이라면 적극 추천. 순수 취업/이직용이라면 가성비를 한 번 더 생각해보세요.',
    },
    {
      title: '요가 강사 3년 프리랜서 생활 솔직 후기',
      content: '센터 소속에서 나와 프리랜서로 전환한 지 3년이 됐어요. 솔직한 후기 남겨봐요.\n\n수입:\n- 초반 6개월은 수입이 들쭉날쭉해서 정말 힘들었어요\n- 지금은 월 고정 출강 3곳 + 개인 레슨 4~5명으로 안정화됐어요\n- 세전 기준 소속 강사 때보다 30% 정도 더 벌고 있어요\n\n좋은 점:\n- 시간 자율성이 압도적으로 좋아요. 오전 수업만 하고 오후는 수련·개인 시간\n- 마음이 안 맞는 센터 원장에게 눈치 보지 않아도 됨\n\n힘든 점:\n- 건강보험료를 혼자 다 내야 하는 게 생각보다 부담\n- 성수기·비수기 편차가 크고, 수강생 이탈이 곧 내 수입 감소로 직결돼요\n- 고용보험 없어서 몸이 아플 때 진짜 무서워요\n\n그래도 다시 선택하라면? 프리랜서 할 것 같아요.',
    },
  ],
};
...
const COMMENT_POOL = {
  자유게시판: [
    '공감해요! 저도 비슷한 경험 있어서 반가웠어요.',
    '좋은 글 감사해요. 많이 배웠습니다.',
    '저도 이런 생각 했었는데 글로 잘 정리해주셨네요!',
    '응원합니다! 잘 되시길 바라요.',
    '정말 공감이 가는 내용이에요. 저도 그런 순간이 있었거든요.',
    '좋은 이야기 나눠주셔서 감사해요. 힘이 되네요.',
    '저도 비슷한 고민 중인데 용기가 생겼어요!',
  ],
  '강사Q&A': [
    '저도 같은 고민을 했었는데, 결국은 직접 전화해서 물어보는 게 제일 빠르더라고요.',
    '제 경험상 서면 계약서는 꼭 받아두시는 게 좋아요. 나중에 분쟁이 생길 수 있거든요.',
    '좋은 질문이에요! 저도 궁금했던 부분이에요.',
    '답변은 아니지만 저도 같은 상황이라 팔로우할게요.',
    '실제로 겪어보니 생각보다 복잡하더라고요. 전문가 상담 받아보시길 추천해요.',
    '관련해서 저도 정보 더 찾아보고 있었는데 감사해요!',
    '이 부분은 센터마다 다를 수 있어요. 직접 확인하시는 게 제일 정확합니다.',
  ],
  노하우: [
    '정말 유익한 정보 감사해요! 바로 적용해볼게요.',
    '이런 내용 찾고 있었는데 타이밍 완벽하네요.',
    '실제 경험에서 나온 노하우라 더 신뢰가 가요. 감사합니다!',
    '저도 이 방법 써봤는데 효과 있었어요. 추천합니다!',
    '추가로 궁금한 게 있는데요, 혹시 초보자도 바로 적용 가능한가요?',
    '이렇게 상세하게 공유해주셔서 정말 감사해요. 저장해뒀어요!',
    '오랫동안 찾던 정보였어요. 감사합니다.',
  ],
  후기: [
    '생생한 후기 감사해요! 저도 한번 해보고 싶어졌어요.',
    '솔직한 후기가 제일 도움이 돼요. 잘 참고하겠습니다!',
    '읽으면서 같이 감동받았어요. 좋은 경험 나눠주셔서 감사해요.',
    '이런 후기가 진짜 도움이 되는 거죠. 구체적으로 적어주셔서 고맙습니다.',
    '저도 비슷한 경험이 있어서 더 와 닿았어요.',
    '다음에 기회 되면 저도 꼭 해보고 싶네요!',
    '진솔한 이야기 공유해주셔서 감사해요.',
  ],
};

function makeComment(postId, category) {
  const pool = COMMENT_POOL[category] || COMMENT_POOL['자유게시판'];
  return {
    post_id: postId,
    user_id: SEED_USER_ID,
...
function makeCommunityPost() {
  const categories = ['자유게시판', '강사Q&A', '노하우', '후기'];
  ...
  if (postErr) {
    ...
    for (const post of insertedPosts) {
      ...
      for (let i = 0; i < count; i++) {
        allComments.push(makeComment(post.id, post.category));
      }
    }
    if (allComments.length > 0) {
      const { data: insertedComments, error: commentErr } = await supabase
        ...
        .select('id, post_id');
      if (commentErr) {
        console.error('❌ 댓글 삽입 실패:', commentErr.message);
        process.exitCode = 1;
      } else {
        console.log(`✅ 댓글 ${insertedComments.length}개 삽입 완료`);
      }
    } else {
      console.log('💬 댓글 0개 (이번 실행은 댓글 없는 게시글만 생성됨)');
    }
  }
